...
from .views import (Index, About, Contact, CoachView, CoachDetail, TicketView, LoginClassView, Register, ProfileView,
                    TicketDetail, BasketAddView, BasketRemoveView, BasketView, BuyTicketView, BasketCoachAddView, BasketCoachDelView, AddActiveTicket)
...
urlpatterns = [
    ...
    path('basket/buy_ticket/add_active/<int:ticket_id>', AddActiveTicket.as_view(), name='add_active')
